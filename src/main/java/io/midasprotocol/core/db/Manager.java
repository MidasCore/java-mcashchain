...
import io.midasprotocol.core.capsule.utils.BlockUtil;
...
import static io.midasprotocol.core.config.Parameter.ChainConstant.SOLIDIFIED_THRESHOLD;
import static io.midasprotocol.core.config.Parameter.NodeConstant.MAX_TRANSACTION_PENDING;
...
public class Manager {
	...
	@Autowired
	private BannedWitnessStore bannedWitnessStore;
	@Autowired
	private BlockRewardStore blockRewardStore;
	// for network
	@Autowired
	...
	public BannedWitnessStore getBannedWitnessStore() {
		return this.bannedWitnessStore;
	}

	public BlockRewardStore getBlockRewardStore() {
		return this.blockRewardStore;
	}
	...
	public void closeAllStore() {
		...
		closeOneStore(bannedWitnessStore);
		closeOneStore(blockRewardStore);
