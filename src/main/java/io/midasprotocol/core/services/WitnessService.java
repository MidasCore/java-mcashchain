...
import io.midasprotocol.common.backup.BackupServer;
...
import io.midasprotocol.core.witness.BlockProductionCondition;
...
import static io.midasprotocol.core.witness.BlockProductionCondition.NOT_MY_TURN;
...
public class WitnessService implements Service {
	...
	//  <witnessAccountAddress,WitnessCapsule>
	@Getter
	 ...
	 * Construction method.
	 */
	public WitnessService(Application tronApp, ApplicationContext context) {
