package io.midasprotocol.common.entity;
...
import io.midasprotocol.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import io.midasprotocol.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
	...
	public Protocol.NodeInfo transferToProtoEntity() {
		...
		if (machineInfo != null) {
			...
			for (MemoryDescInfo memoryDescInfo : machineInfo.getMemoryDescInfoList()) {
				Protocol.NodeInfo.MachineInfo.MemoryDescInfo.Builder descBuilder =
						Protocol.NodeInfo.MachineInfo.MemoryDescInfo.newBuilder();
			...
			for (DeadLockThreadInfo deadLockThreadInfo : machineInfo.getDeadLockThreadInfoList()) {
				Protocol.NodeInfo.MachineInfo.DeadLockThreadInfo.Builder deadBuilder =
						Protocol.NodeInfo.MachineInfo.DeadLockThreadInfo.newBuilder();
