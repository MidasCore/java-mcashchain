...
import static io.midasprotocol.common.storage.Type.VALUE_TYPE_UNKNOWN;
...
public class Value {
	...
	public VoteChangeCapsule getVoteChange() {
		if (ArrayUtils.isEmpty(any)) {
			return null;
		}
	 ...
	 */
	public StakeChangeCapsule getStakeChange() {
		if (ArrayUtils.isEmpty(any)) {
			return null;
		}
		return new StakeChangeCapsule(any);
	}

	/**
	 * @return StakeAccountCapsule
	 */
	public StakeAccountCapsule getStakeAccount() {
		if (ArrayUtils.isEmpty(any)) {
			return null;
		}
		return new StakeAccountCapsule(any);
	}
