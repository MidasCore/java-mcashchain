  ...
  private static final byte[] toAddress = Base58
	...
	public Boolean createAssetIssue(byte[] address, String name, Long totalSupply, Integer trxNum,
		...
		try {
			...
			builder.setFreeAssetBandwidthLimit(10000);
			builder.setPublicFreeAssetBandwidthLimit(10000);
	...
	public boolean unFreezeAsset2(byte[] addRess, String priKey) {
		...
		GrpcAPI.TransactionExtension TransactionExtension = blockingStubFull.unfreezeAsset(contract);
