...
public class Base58 {
	...
	public static final char[] ALPHABET = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz"
			.toCharArray();
	private static final int BASE58CHECK_ADDRESS_SIZE = 28;
	...
	public static byte[] decodeFromBase58Check(String addressBase58) {
		...
		byte[] address = decodeBase58(addressBase58);
	...
	private static byte[] decodeBase58(String input) {
		if (!input.startsWith("M"))
			return null;
		return Base58.decode(input.substring(1));
	}
