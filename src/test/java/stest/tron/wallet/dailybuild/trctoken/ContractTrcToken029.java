...
public class ContractTrcToken029 {
	...
	public void deploy01TransferTokenContract() {
		...
		logger.info("dev001Address:" + Base58.encodeBase58(dev001Address));
		...
		String code = Configuration.getByPath("testng.conf")
				.getString("code.code_ContractTrcToken029_tokenTest");
		String abi = Configuration.getByPath("testng.conf")
				.getString("abi.abi_ContractTrcToken029_tokenTest");
		transferTokenContractAddress = PublicMethed.deployContract(contractName, abi, code, "", maxFeeLimit,
	...
	public void deploy02TransferTokenContract() {
		...
		ByteString fakeTokenId = ByteString
				.copyFromUtf8(Long.toString(assetAccountDev + 100));
		...
		Assert.assertSame(afterAssetIssueContractAddress, beforeAssetIssueContractAddress);
