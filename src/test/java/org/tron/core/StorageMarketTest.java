...
public class StorageMarketTest {
	...
	public void createAccountCapsule() {
		...
		dbManager.getDynamicPropertiesStore().saveTotalStorageReserved(
				128L * 1024 * 1024 * 1024);
		dbManager.getDynamicPropertiesStore().saveTotalStoragePool(100_000_000_000_000L);
	...
	public void testBuyStorage() {
		...
		Assert.assertEquals(currentPool, 100_000_000_000_000L);
	...
	public void testBuyStorage2() {
		...
		long quant = ConversionUtil.McashToMatoshi(1_000_000); // 2 million trx
	...
	public void testBuyStorageBytes() {
		...
		Assert.assertEquals(owner.getBalance(), initBalance - ConversionUtil.McashToMatoshi(2_000_000)
				- ChainConstant.TRANSFER_FEE);
	...
	public void testBuyStorageBytes2() {
		...
		Assert.assertEquals(owner.getBalance(), initBalance - ConversionUtil.McashToMatoshi(1_000_000)
				- ChainConstant.TRANSFER_FEE);
		...
		Assert.assertEquals(owner.getBalance(), initBalance - 2 * ConversionUtil.McashToMatoshi(1_000_000)
				- ChainConstant.TRANSFER_FEE);
	...
	public void testSellStorage() {
		...
		long quant = ConversionUtil.McashToMatoshi(2_000_000);
		storageMarket.buyStorage(owner, quant);
