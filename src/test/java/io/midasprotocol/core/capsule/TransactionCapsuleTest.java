...
public class TransactionCapsuleTest {
	...
	public static void init() {
		...
		OWNER_ACCOUNT_NOT_EXIST = Wallet.getAddressPreFixString() + "548794500882809695a8a687866e76d4271a3456";
...
//              .encodeBase58Check(ByteArray.fromHexString(KEY_ADDRESS_21))
...
//    } catch (PermissionException e) {
//      Assert.assertEquals(e.getMessage(),
//          Wallet.encodeBase58Check(ByteArray.fromHexString(KEY_ADDRESS_11)) + " has signed twice!");
//    } catch (SignatureFormatException e) {
//      Assert.assertFalse(true);
//    }
//
...
//    } catch (PermissionException e) {
//      Assert.assertEquals(e.getMessage(),
//          KEY_11 + "'s address is " + Wallet.encodeBase58Check(ByteArray.fromHexString(KEY_ADDRESS_11))
//              + " but it is not contained of permission.");
//    } catch (SignatureException e) {
//      Assert.assertFalse(true);
//    } catch (SignatureFormatException e) {
...
//    } catch (PermissionException e) {
//      Assert.assertEquals(e.getMessage(),
//          Wallet.encodeBase58Check(ByteArray.fromHexString(OWNER_ADDRESS)) + " had signed!");
//    } catch (SignatureException e) {
//      Assert.assertFalse(true);
//    } catch (SignatureFormatException e) {
//      Assert.assertFalse(true);
...
//              .encodeBase58Check(ByteArray.fromHexString(OWNER_ADDRESS))
//              + " but it is not contained of permission.");
//    } catch (SignatureException e) {
//      Assert.assertFalse(true);
//    } catch (SignatureFormatException e) {
...
//              .encodeBase58Check(ByteArray.fromHexString(KEY_ADDRESS_11))
//              + " but it is not contained of permission.");
//    } catch (SignatureException e) {
//      Assert.assertFalse(true);
//    } catch (SignatureFormatException e) {
...
//    } catch (PermissionException e) {
//      Assert.assertEquals(e.getMessage(),
//          Wallet.encodeBase58Check(ByteArray.fromHexString(KEY_ADDRESS_21)) + " has signed twice!");
//    } catch (SignatureFormatException e) {
//      Assert.assertFalse(true);
//    }
//
